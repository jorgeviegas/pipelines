 ...
 */
package com.sap.cd.athenas.fulfilmentprocess.test.jobs;
...
import com.sap.cd.athenas.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AthenasFulfilmentProcessConstants.ORDER_PROCESS_NAME;
