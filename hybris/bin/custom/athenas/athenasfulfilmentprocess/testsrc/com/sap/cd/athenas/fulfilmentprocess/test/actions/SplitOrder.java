 ...
 */
package com.sap.cd.athenas.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AthenasFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AthenasFulfilmentProcessConstants.PARENT_PROCESS);
