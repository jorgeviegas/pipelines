 ...
 */
package com.sap.cd.athenas.test.setup;
...
import com.sap.cd.athenas.test.constants.AthenasTestConstants;
import com.sap.cd.athenas.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AthenasTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/athenastest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/athenastest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/athenastest/import/cstickets.impex");
			...
			importImpexFile(context, "/athenastest/import/csquotes.impex");
		}
	}
}
