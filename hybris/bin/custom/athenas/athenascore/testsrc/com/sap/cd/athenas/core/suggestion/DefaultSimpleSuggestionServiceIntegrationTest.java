 ...
 */
package com.sap.cd.athenas.core.suggestion;
...
import com.sap.cd.athenas.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/athenascore/test/testSimpleSuggestionService.csv", "utf-8");
	}
