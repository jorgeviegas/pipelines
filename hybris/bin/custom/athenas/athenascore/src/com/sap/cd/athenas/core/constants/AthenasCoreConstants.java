 ...
 */
package com.sap.cd.athenas.core.constants;

/**
 * Global class for all AthenasCore constants. You can add global constants for your extension into this class.
 */
public final class AthenasCoreConstants extends GeneratedAthenasCoreConstants
{
	public static final String EXTENSIONNAME = "athenascore";


	private AthenasCoreConstants()
	{
		//empty
	}
