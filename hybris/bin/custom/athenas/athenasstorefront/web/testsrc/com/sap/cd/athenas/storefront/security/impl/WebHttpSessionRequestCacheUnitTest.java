...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/athenasstorefront/electronics/en",
						"https://electronics.local:9002/athenasstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/athenasstorefront/electronics/en",
						"https://electronics.local:9002/athenasstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/athenasstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/athenasstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/athenasstorefront/electronics/en",
						"https://electronics.local:9002/athenasstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/athenasstorefront",
						"https://electronics.local:9002/athenasstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/athenasstorefront",
						"https://electronics.local:9002/athenasstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/athenasstorefront/electronics/en",
						"https://electronics.local:9002/athenasstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
